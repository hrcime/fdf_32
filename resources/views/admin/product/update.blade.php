            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @include('error')
                        {{ Form::open(['action' => ['Admin\ProductController@update', $product->id], 'enctype' => 'multipart/form-data', 'role' => 'form', 'method' => 'PUT']) }}
                        <div class="row form-horizontal">
                            <div class="col-md-4">
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        {{ Form::number('price', old('price', $product->price), ['class' => 'form-control', 'required']) }}
                                        @if ($errors->has('price'))
                                            <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        {{ Form::number('quantity', old('quantity', $product->quantity), ['class' => 'form-control', 'required']) }}
                                ...
                                <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        {{ Form::select('category_id', $categories, old('category_id', $product->category_id), ['placeholder' => '','class' => 'form-control']) }}
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        {{ Form::submit(trans('layout.product.b-update'), ['class' => 'btn btn-primary btn-block']) }}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group{{ $errors->has('information') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        {{ Form::textarea('information', old('information', $product->information), ['class' => 'form-control', 'required']) }}
